...
const LandingPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning algorithms detect vulnerabilities with 99.9% accuracy, analyzing patterns across millions of smart contracts.',
      gradient: 'from-blue-500 to-cyan-500'
    },
    {
      icon: <Shield className="h-8 w-8" />,
      title: 'Real-time Security',
      description: 'Instant vulnerability detection with comprehensive threat analysis and automated security recommendations.',
      gradient: 'from-purple-500 to-pink-500'
    },
    {
      icon: <Zap className="h-8 w-8" />,
      title: 'Gas Optimization',
      description: 'Intelligent gas usage analysis with actionable optimization suggestions to reduce transaction costs.',
      gradient: 'from-orange-500 to-red-500'
    },
    {
      icon: <FileText className="h-8 w-8" />,
      title: 'Detailed Reports',
      description: 'Professional audit reports with severity ratings, fix recommendations, and compliance verification.',
  ...
  const steps = [
    {
      ...
      description: 'Paste your Solidity code or connect your wallet for automatic contract detection.',
    ...
    },
    {
      step: '02',
      title: 'AI Analysis',
      description: 'Our advanced AI engine performs comprehensive security analysis in real-time.',
      icon: <Cpu className="h-8 w-8" />,
    ...
    },
    {
      step: '03',
      title: 'Get Results',
      description: 'Receive detailed reports with actionable insights and security recommendations.',
      icon: <FileText className="h-8 w-8" />,
  ...
  const testimonials = [
    {
      ...
      content: 'Audit Wolf caught critical vulnerabilities that other tools missed. It saved our protocol from potential exploits worth millions. The AI analysis is incredibly thorough.',
      rating: 5,
      avatar: 'AC',
    ...
    },
    {
      ...
      content: 'The speed and accuracy are unmatched. What used to take days now takes minutes. Audit Wolf has revolutionized our security workflow.',
      rating: 5,
      avatar: 'SK',
      company: 'BlockSec'
    },
    {
      ...
      content: 'Fast, reliable, and comprehensive. The gas optimization suggestions alone have saved us thousands in transaction costs.',
      rating: 5,
      avatar: 'MR',
  ...
  const stats = [
    { value: '10M+', label: 'Lines Analyzed', icon: <Code className="h-5 w-5" /> },
    { value: '50K+', label: 'Contracts Audited', icon: <Shield className="h-5 w-5" /> },
    { value: '99.9%', label: 'Accuracy Rate', icon: <Award className="h-5 w-5" /> },
    { value: '500+', label: 'Teams Trust Us', icon: <Users className="h-5 w-5" /> }
  ];
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              AI-powered smart contract auditor that provides comprehensive security analysis 
              and generates detailed reports in <span className="text-blue-600 dark:text-blue-400 font-semibold">minutes, not days</span>.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Advanced AI analysis, real-time security monitoring, and comprehensive reporting 
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Get comprehensive security analysis without complex setup. 
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Join the community of developers and security teams who trust Audit Wolf 
              ...
              <div className="p-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-2xl shadow-xl relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
                    Join thousands of developers who trust Audit Wolf to keep their 
                    smart contracts secure and optimized.
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md leading-relaxed">
                AI-powered smart contract auditor that provides comprehensive security analysis 
                and reports for Solidity contracts. Secure your DeFi projects with confidence.
              </p>
            ...
            {/* Product Links */}
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-6">Product</h3>
          ...
          <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-8 mt-12">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-600 dark:text-gray-300 mb-4 md:mb-0">
                © 2025 Audit Wolf. All rights reserved. Built with security in mind.
              </p>
